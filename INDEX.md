...
| `account` — Currency Exchange & Transit Accounts | [`currency_exchange_transit.md`](currency_exchange_transit.md) | Complete — transit account concept, exchange gain/loss accounts, internal transfers between currency-different banks, exchange difference auto-creation during reconciliation, rate priority, outstanding accounts, paired transfers, configuration, accountant's perspective | 2026-03-23 |
