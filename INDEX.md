...
| `account` — Currency Exchange & Transit Accounts | [`currency_exchange_transit.md`](currency_exchange_transit.md) | Rewritten — v19-verified, 3 real-case examples with full journal entries, step-by-step configuration, v19 internal transfer changes (auto-pairing removed), exchange difference mechanics, 2 methods for bank-to-bank transfers | 2026-03-23 |
